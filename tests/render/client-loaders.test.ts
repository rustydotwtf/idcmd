...
const seedClientFile = async (
  ...
  await writeTextFile(joinPath(root, "site", "src", "ui", fileName), text);
};
...
describe("client loaders", () => {
  it("loads custom layout from site/src/ui/layout.tsx", async () => {
  ...
  it("loads custom right rail from site/src/ui/right-rail.tsx", async () => {
    await withClientFile(
  ...
  it("loads custom search-page renderer from site/src/ui/search-page.tsx", async () => {
    await withClientFile(
